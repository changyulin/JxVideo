...
using Jx.Core.Plugins;
using Jx.Data;
using Jx.Services.Affiliates;
using Jx.Services.Authentication;
using Jx.Services.Authentication.External;
using Jx.Services.Blogs;
using Jx.Services.Catalog;
using Jx.Services.Cms;
using Jx.Services.Common;
using Jx.Services.Configuration;
using Jx.Services.Customers;
using Jx.Services.Directory;
using Jx.Services.Discounts;
using Jx.Services.Events;
using Jx.Services.ExportImport;
using Jx.Services.Forums;
using Jx.Services.Helpers;
using Jx.Services.Infrastructure;
using Jx.Services.Installation;
using Jx.Services.Localization;
using Jx.Services.Logging;
using Jx.Services.Media;
using Jx.Services.Messages;
using Jx.Services.News;
using Jx.Services.Orders;
using Jx.Services.Payments;
using Jx.Services.Polls;
using Jx.Services.Security;
using Jx.Services.Seo;
using Jx.Services.Shipping;
using Jx.Services.Stores;
using Jx.Services.Tasks;
using Jx.Services.Tax;
using Jx.Services.Topics;
using Jx.Services.Vendors;
using Jx.Web.Framework.Mvc.Routes;
using Jx.Core.Data;
//using Jx.Web.Framework.Themes;
//using Jx.Web.Framework.UI;

namespace Jx.Web.Framework
{
    /// <summary>
    ...
    public class DependencyRegistrar : IDependencyRegistrar
    {
        ...
        public virtual void Register(ContainerBuilder builder, ITypeFinder typeFinder, NopConfig config)
        {
            ...
            //}
            builder.Register<IDbContext>(c => new NopObjectContext()).InstancePerLifetimeScope();
            ...
            builder.RegisterType<JxCodeService>().As<IJxCodeService>().InstancePerLifetimeScope();
