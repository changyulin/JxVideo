...
namespace Jx.Services.Installation
{
        ...
        protected virtual void InstallScheduleTasks()
        {
            var tasks = new List<ScheduleTask>
            {
                new ScheduleTask
                {
                    Name = "Send emails",
                    Seconds = 60,
                    Type = "Jx.Services.Messages.QueuedMessagesSendTask, Jx.Services",
                    Enabled = true,
                    StopOnError = false,
                },
                new ScheduleTask
                {
                    Name = "Keep alive",
                    Seconds = 300,
                    Type = "Jx.Services.Common.KeepAliveTask, Jx.Services",
                    Enabled = true,
                    StopOnError = false,
                },
                new ScheduleTask
                {
                    Name = "Delete guests",
                    Seconds = 600,
                    Type = "Jx.Services.Customers.DeleteGuestsTask, Jx.Services",
                    Enabled = true,
                    StopOnError = false,
                },
                new ScheduleTask
                {
                    Name = "Clear cache",
                    Seconds = 600,
                    Type = "Jx.Services.Caching.ClearCacheTask, Jx.Services",
                    Enabled = false,
                    StopOnError = false,
                },
                new ScheduleTask
                {
                    ...
                    //60 minutes
                    Seconds = 3600,
                    Type = "Jx.Services.Logging.ClearLogTask, Jx.Services",
                    Enabled = false,
                    StopOnError = false,
                },
                new ScheduleTask
                {
                    ...
                    //60 minutes
                    Seconds = 3600,
                    Type = "Jx.Services.Directory.UpdateExchangeRateTask, Jx.Services",
                    Enabled = true,
                    StopOnError = false,
                },
            };
